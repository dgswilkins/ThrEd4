...
namespace internal {
	...
	void chksid(unsigned int vertexIndex, unsigned clipIntersectSide, std::vector<fPOINT>* currentFormVertices);
	...
	unsigned leftsid(std::vector<fPOINT>* currentFormVertices);
