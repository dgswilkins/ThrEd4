...
void thi::box(uint32_t iNearest, HDC dc) {
...
void thi::selin(uint32_t start, uint32_t end, HDC dc) {
...
void thi::stchbox(uint32_t iStitch, HDC dc) {
  auto       line   = std::array<POINT, SQPNTS> {};
