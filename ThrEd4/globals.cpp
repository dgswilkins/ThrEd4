...
std::vector<HWND>*             DefaultColorWin           = nullptr; // default color windows
...
std::array<wchar_t, MSGSIZ>    MsgBuffer                 = {};      // for user messages
uint32_t                       MsgIndex                  = 0U;      // pointer to the message buffer
...
std::vector<HWND>*             UserColorWin              = nullptr; // user color windows
