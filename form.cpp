...
#else
	unsigned short s1 = **static_cast<unsigned short * const *>(arg1);
	unsigned short s2 = **static_cast<unsigned short * const *>(arg2);
	if (s2 == s1) return 0;
	if (s2 < s1) return 1;
	return -1;
#endif
...
#else
	float local1 = **static_cast<float * const *>(arg1), local2 = **static_cast<float * const *>(arg2);
